...
This was set out formally by <strong>Professor Olu Longe (1932–2020)</strong>, Nigeria's first Professor of Computer Science, whose 1983 University of Ibadan inaugural lecture, <em>Ifá Divination and Computer Science</em>, showed the byte, the nibble, Boolean logic, and memory addressing already alive within Ifá. Yet Ifá's meaning has never lived in books alone: for centuries the babaláwo have carried its verses in an unbroken oral lineage, and they carry them still — the living voices, including those honoured in this app, through whom the tradition keeps itself. Scholars have documented them for the wider world; the babaláwos have kept it alive.<br><br>
Beneath it lies one idea the Yorùbá named long ago — <em>Ìbí/Ayewo</em> and <em>Ire</em>, shadow and light, the two poles whose meeting weaves all of experience. It is the same intuition mathematics writes in Euler's formula and machines run in silicon: from exactly two, held in balance, everything follows. <em>Èjèèjì ni mo gbè mi o gbe enikan soso</em> — "I support two" — as the first Odù (Ejiogbe) says.
</p>
